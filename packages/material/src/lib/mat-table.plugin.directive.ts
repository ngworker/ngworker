...
import { AfterContentInit, ContentChild, ContentChildren, Directive, HostListener, QueryList } from '@angular/core';
import { CDK_SPREADSHEET_DROP_LIST_PROVIDERS, CdkSpreadsheetDropListDirective } from './cdk-spreadsheet-drop-list';
...
export class MatTablePluginDirective extends CdkSpreadsheetDropListDirective implements AfterContentInit {
