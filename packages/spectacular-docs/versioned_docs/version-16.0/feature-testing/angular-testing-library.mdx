...
[`routes`](../api/interfaces/ProvideSpectacularFeatureTestingOptions.md#routes)
...
[`TestBed.inject`](https://v16.angular.io/api/core/testing/TestBed#inject) to
...
[`Location#path`](https://v16.angular.io/api/common/Location#path) service
