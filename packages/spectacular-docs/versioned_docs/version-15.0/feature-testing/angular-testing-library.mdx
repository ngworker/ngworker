...
simple component with a router outlet that will host all of our feature's
routes.
...
the
[`featurePath`](../api/interfaces/ProvideSpectacularFeatureTestingOptions.md#featurepath)
...
[`TestBed.inject`](https://v15.angular.io/api/core/testing/TestBed#inject) to
...
[`Location#path`](https://v15.angular.io/api/common/Location#path) service
