...
To set up standalone feature routes for a feature test, specify the [featurePath](../../api/interfaces/CreateFeatureHarnessOptions.md#featurepath) option and add a route to the [routes](../../api/interfaces/CreateFeatureHarnessOptions.md#routes) array option that wraps the standalone routes.
...
To set up a routed feature for a feature test, specify the [featurePath](../../api/interfaces/CreateFeatureHarnessOptions.md#featurepath) option and add a route to the [routes](../../api/interfaces/CreateFeatureHarnessOptions.md#routes) array option that wraps the routed feature module.
