...
Angular's testbed supports [automatic change detection](https://v15.angular.io/guide/testing-components-scenarios#automatic-change-detection). So does Spectacular.
