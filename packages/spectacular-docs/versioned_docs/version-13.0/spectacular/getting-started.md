...
Angular's testbed supports [automatic change detection](https://v13.angular.io/guide/testing-components-scenarios#automatic-change-detection). So does Spectacular.
