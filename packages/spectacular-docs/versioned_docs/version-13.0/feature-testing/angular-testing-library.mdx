...
Firstly, we use
[`SpectacularAppComponent`](../api/classes/SpectacularAppComponent.md) as our
...
[`SpectacularAppComponent`](../api/classes/SpectacularAppComponent.md) is a
simple component with a router outlet that will host all our feature's routes.

Next, we register our feature by calling
[`SpectacularFeatureTestingModule.withFeature`](../api/classes/SpectacularFeatureTestingModule.md#withfeature)
...
[`routes`](../api/interfaces/SpectacularFeatureTestingModuleOptions.md#routes)
...
application to the
[`featurePath`](../api/interfaces/SpectacularFeatureTestingModuleOptions.md#featurepath)
...
The [`SpectacularAppComponent`](../api/classes/SpectacularAppComponent.md) is
declared by
[`SpectacularFeatureTestingModule.withFeature`](../api/classes/SpectacularFeatureTestingModule.md#withfeature)
so we set the
...
and
[`SpectacularFeatureTestingModule.withFeature`](../api/classes/SpectacularFeatureTestingModule.md#withfeature)
instead of [`createFeatureHarness`](../api/modules.md#createfeatureharness).

Because of this, we don't get a reference to a
[`SpectacularFeatureHarness`](../api/interfaces/SpectacularFeatureHarness.md).
...
[`TestBed.inject`](https://v13.angular.io/api/core/testing/TestBed#inject) to
...
[`SpectacularFeatureLocation`](../api/classes/SpectacularFeatureLocation.md) and
[`SpectacularFeatureRouter`](../api/classes/SpectacularFeatureRouter.md).
...
[`Location#path`](https://v13.angular.io/api/common/Location#path) service
...
[`SpectacularFeatureLocation`](../api/classes/SpectacularFeatureLocation.md):
